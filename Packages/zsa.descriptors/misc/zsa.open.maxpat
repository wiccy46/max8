...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 345.5, 87.0, 18.0 ],
					"text" : "getpath extras"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 520.0, 170.5, 223.0, 24.0 ],
					"text" : "zsa.something as first backreference"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 369.0, 164.0, 104.0, 37.0 ],
					"text" : "just the name without zsa."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 353.5, 150.0, 33.0 ],
					"text" : "this updates the title and description in the help file"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 329.5, 129.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 389.0, 83.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 85.0, 159.0, 20.0 ],
					"text" : "loadmess get_parent_name"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 465.0, 137.0, 265.0, 20.0 ],
					"text" : "regexp (zsa\\\\.(.+)).maxhelp @substitute Zsa.%2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 561.0, 367.0, 163.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.0, 111.0, 83.0, 20.0 ],
					"saved_object_attributes" : 					{
						"filename" : "zsa.utils.js",
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"textcolor" : [ 0.85, 0.53, 0.25, 0.6804 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 52.0, 296.0, 195.402344, 21.40625 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 195.402344, 21.40625 ],
					"text" : "open Zsa.Descriptors Overview",
					"textcolor" : [ 0.85, 0.53, 0.25, 0.778759 ],
					"textoncolor" : [ 0.85098, 0.533333, 0.254902, 1.0 ],
					"textovercolor" : [ 0.533333, 0.65098, 0.286275, 1.0 ],
					"textoveroncolor" : [ 0.85098, 0.533333, 0.254902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 416.0, 194.0, 17.0 ],
					"text" : "loadunique $1/zsa.overview.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 442.0, 57.0, 19.0 ],
					"text" : "pcontrol"
				}
